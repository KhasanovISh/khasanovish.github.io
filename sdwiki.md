...
7. Нажимаем **Start** и ждём, когда в консоли появится сообщение "Model loaded".

![Консоль](https://i.imgur.com/6h5BZpm.png)

### Шаг 5: Использование

8. Открываем свой браузер и переходим по адресу [http://127.0.0.1:7860/](http://127.0.0.1:7860/) для доступа к интерфейсу приложения.
