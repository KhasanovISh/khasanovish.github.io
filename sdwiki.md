Этот тернистый путь в мир магии нейросетей не потребует много времени — около 30 минут, зато к концу пути вы станете немного волшебниками. Все вопросы можно задавать мне в личные сообщения в Telegram https://t.me/LoFiLight
...
![image](https://hackmd.io/_uploads/SJQskS936.png)

![image](https://hackmd.io/_uploads/Sk0XMPqnT.png)


4. Переходим по Discover Page и в поисковой строке набираем "automatic1111"
![image](https://hackmd.io/_uploads/S1hSnEc3p.png)
...
![image](https://hackmd.io/_uploads/HkefyXv5ha.png)


Нажимаем Start снова открывается консоль ждём когда появится строчка "Model loaded"

![image](https://hackmd.io/_uploads/S1KmQD92a.png)


![image](https://hackmd.io/_uploads/B1o5Qv53T.png)


Открываем свой бразуер (Chrome, Firefox и т.д.) по адресу http://127.0.0.1:7860/

![image](https://hackmd.io/_uploads/BJu1VPqhT.png)


## Automatic1111

Это интерефейс для работы с нейросетью Stable Diffusion через браузер, например через localhost http://127.0.0.1:7860/
...
![image](https://hackmd.io/_uploads/BJxGPvcnT.png)
...
Скачиваем эту модицификацию модели DreamShaper XL v2.1 Turbo DPM++ SDE на сайте https://civitai.com/models/112902/dreamshaper-xl

![image](https://hackmd.io/_uploads/H1KzHwc26.png)
...
![image](https://hackmd.io/_uploads/rkbLIH5na.png)
...
![image](https://hackmd.io/_uploads/rJWjLB5np.png)


3. Обновляем список нейросетей в браузере

![image](https://hackmd.io/_uploads/By6H8Pchp.png)
...
![image](https://hackmd.io/_uploads/HkEFwwq2T.png)
...
![image](https://hackmd.io/_uploads/S1koRr93T.png)
...
![Clipboard_02-26-2024_06](https://hackmd.io/_uploads/rkQVgP92p.jpg)
> cartoon illustration of full body Barbie doll in pink dress, short blonde hairs, by Patrick Nagel,vector art,few colors,bright
...
14. Ждём и открываем папку с изображениями нажав на иконку папки под полем Generate.

![image](https://hackmd.io/_uploads/rJ-948q3a.png)


16. Скидываем их на общий диск в соответствующую папку. Приглашения для доступа к папке я высылаю на рабочую почту:
